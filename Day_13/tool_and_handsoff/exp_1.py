...
zoology_agent = Agent(
    name="Zoology_Agent",
    instructions = "You are an animal specialist. Your job is to provide accurate yet concise information or summaries about animals, including their classification, lifestyle, body systems, and environmental needs. Answer all questions like a zoology expert."
)
...
result = Runner.run_sync(
    ...
    2. Any breaking news?
    3. How does a frog's respiratory system work?
